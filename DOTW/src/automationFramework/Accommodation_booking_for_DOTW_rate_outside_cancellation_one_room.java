...
public class Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room {
	...
	Logger logger = Logger.getLogger("Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room");
	
	 @Test
	 @Parameters({ "browsername" })
	  public void bookdotw(String browsername) throws Exception {
		  test = rep.startTest("bookdotw");
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				username.clear();
				username.sendKeys(excel.getData(6, 1, 0));
				WebElement password = driverqa.findElement(LoginPage.pwd);
				password.clear();
				password.sendKeys(excel.getData(6, 1, 1));
		...
		logger.info("Searching Customer");
			 ...
			 try {
				 ...
				 driverqa.findElement(Operations.company).sendKeys(excel.getData(6, 4, 0));
				 Thread.sleep(1000);
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room/Customer-list.jpg");
			 ...
			 try{
				 ...
				 driverqa.findElement(NewAccoBooking.AccomUnit).sendKeys(excel.getData(6, 7, 0));
				 Thread.sleep(2000);
				 action.sendKeys(Keys.ARROW_DOWN).build().perform();
				 action.sendKeys(Keys.ENTER).build().perform();
				 driverqa.findElement(NewAccoBooking.inDate).clear();
				 driverqa.findElement(NewAccoBooking.inDate).sendKeys(excel.getData(6, 10, 0));
				 driverqa.findElement(NewAccoBooking.outDate).clear();
				 driverqa.findElement(NewAccoBooking.outDate).sendKeys(excel.getData(6, 10, 1));
				 String expected=excel.getData(6, 7, 0);
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room/Search-Hotel-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room/Search-Result.jpg");
	         ...
	         try {
				driverqa.findElement(NewAccoBooking.directroomType).click();
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room/Selected-room-available.jpg");
				 Thread.sleep(1000);
				 ...
				 driverqa.findElement(NewAccoBooking.paxFname).sendKeys(excel.getData(6, 14, 0));
				 Thread.sleep(2000);
				 driverqa.findElement(NewAccoBooking.paxLname).sendKeys(excel.getData(6, 14, 1));
				 ...
				 Thread.sleep(3000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() +  "/Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room/Passenger-Details.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_DOTW_rate_outside_cancellation_one_room/After-booking.jpg");
